function startAnim(){
    ...
    startTime += 0.5;
    SM.to("#textbg", 0.5, { rotateY:0, ease:Power1.easeOut}, startTime);
    SM.to("#photo", 0.5, { rotateY:0, ease:Power1.easeOut}, startTime);
    ...
    startTime += 0.5;
    SM.to("#text-2", 0.5, { x:0, opacity:1, ease:Power0.easeOut}, startTime);

    startTime += 0.5;
    SM.to("#text-3", 0.5, { x:0, opacity:1, ease:Power0.easeOut}, startTime);
